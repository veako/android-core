...
interface IArgumentsFromIntent {
    ...
    fun getBooleanFromIntent(key: String, defValue: Boolean = false): Boolean {
        return getArgumentsIntent()?.getBooleanExtra(key, defValue) ?:defValue
    }
    ...
    fun getByteFromIntent(key: String, defValue: Byte = 0): Byte {
        return getArgumentsIntent()?.getByteExtra(key, defValue) ?:defValue
    }
    ...
    fun getCharFromIntent(key: String, defValue: Char = ' '): Char {
        return getArgumentsIntent()?.getCharExtra(key, defValue) ?:defValue
    }
    ...
    fun getDoubleFromIntent(key: String, defValue: Double = 0.0): Double {
        return getArgumentsIntent()?.getDoubleExtra(key, defValue) ?:defValue
    }

    fun getExtrasFromIntent(): Bundle? {
    ...
    fun getFloatFromIntent(key: String, defValue: Float = 0f): Float {
        return getArgumentsIntent()?.getFloatExtra(key, defValue) ?:defValue
    }
    ...
    fun getIntFromIntent(key: String, defValue: Int = 0): Int {
        return getArgumentsIntent()?.getIntExtra(key, defValue) ?:defValue
    }
    ...
    fun getLongFromIntent(key: String, defValue: Long = 0): Long {
        return getArgumentsIntent()?.getLongExtra(key, defValue) ?:defValue
    }
    ...
    fun getShortFromIntent(key: String, defValue: Short = 0): Short {
        return getArgumentsIntent()?.getShortExtra(key, defValue) ?:defValue
    }
