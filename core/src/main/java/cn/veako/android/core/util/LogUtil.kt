...
import cn.veako.android.core.BuildConfig
...
object LogUtil {
     ...
     */
    private var mIsForceLog = false

    /**
     * Log 密码
     */
    private var mLogPwd: String = if (BuildConfig.DEBUG) "12345678" else BaseApp.getInstance().packageName
    ...
    private fun initLogHandler() {
        ...
        mCurDateTime = DateUtil.dateTimeNow(DateUtil.parsePatterns[12])
        ...
        mHandler = object : Handler(handlerThread.looper) {
            override fun handleMessage(msg: Message) {
                val dateTime = DateUtil.dateTimeNow(DateUtil.parsePatterns[12])
                ...
                mBufferWrite.write(DateUtil.dateTimeNow(DateUtil.parsePatterns[12]) + "/" + msg.obj.toString())
